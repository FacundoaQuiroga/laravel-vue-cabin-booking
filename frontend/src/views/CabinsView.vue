...
<el-space direction="vertical" :size="80" style="width: 100%;">
    <el-form :model="form" label-width="180px" style="width: 100%" >

        <el-form-item label="Nombre de Cabaña" >
            <el-input v-model="form.name" :error="errors.name?.[0]" style="width: 420px"/>
        </el-form-item>
  ...
  <el-table :data="cabins" style="width: 100%">
        ...
        <el-table-column label="Acciones" width="360">
